...
const Navbar = () => {
    return (
        <motion.div
                className="flex flex-col bg-gray-900 text-white z-10 overflow-y-auto"
                variants={container}
                initial="hidden"
                animate="visible"
            ...
            <nav className="flex flex-col grow">
                ...
                >
                    <Link href="/">
                        <img src={"../pp-square.png"} className="bg-gray-800 rounded-full" style={{width:'200px'}}></img>
                    </Link>
                ...
                <motion.div className="flex grow flex-col">
                    ...
                    <div className="flex grow flex-col justify-end p-8">
                        ...
                        <div className="flex mt-3 flex-col">
                            ...
                            <a className="flex mt-3" href="https://www.linkedin.com/in/lucas-leleu-bb24151b9/"><img className="mr-2" style={{width:'25px', height:'25px'}} src="../Linkedin.png"></img><p>Lucas Leleu</p></a>
                            <a className="flex mt-3" href="https://www.instagram.com/l.lucass_/"><img className="mr-2" style={{width:'25px', height:'25px'}} src="../Instagram.png"></img><p>l.lucass_</p></a>
                        </div>
                    </div>
                </motion.div>
            </nav>
